...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title">
      <?php echo lang('deactivate_heading');?> <small><?php echo sprintf(lang('deactivate_subheading'), $user->username);?></small>
      </h3>
      <div class="page-bar">
        ...
        <div class="col-md-12">
          <div class="portlet box blue">
            ...
            <div class="portlet-body form">
              <form role="form" action="<?php echo base_url('auth/deactivate/'.$user->id) ?>" method="POST">
                <div class="form-body">
                  <div class="form-group form-md-line-input">
                    <div class="col-md-12">
                      <div class="md-radio-inline">
                        <div class="md-radio">
                          <input type="radio" id="confirm_yes" name="confirm" value="yes" checked="checked" class="md-radiobtn">
                            <label for="confirm_yes">
                            <span></span>
                        ...
                        <div class="md-radio">
                          <input type="radio" id="confirm_no" name="confirm" value="no" class="md-radiobtn">
                            <label for="confirm_no">
                            <span></span>
                            <span class="check"></span>
                            <span class="box"></span>
                ...
                <div class="form-actions noborder">
                  <button type="submit" class="btn blue"><?php echo lang('deactivate_submit_btn') ?></button>
