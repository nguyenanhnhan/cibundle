...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title">
      <?php echo lang('edit_user_heading');?> <small><?php echo lang('edit_user_subheading');?></small>
      </h3>
      <div class="page-bar">
        ...
        <div class="col-md-12">
          <div class="portlet box blue">
            ...
            <div class="portlet-body form">
              <form role="form" action="<?php echo base_url(uri_string()) ?>" method="POST">
                <div class="form-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" class="form-control input-sm" id="first_name" name="first_name" value="<?php echo $first_name['value'] ?>">
                    ...
                    <div class="col-md-6">
                      <div class="form-group form-md-line-input form-md-floating-label">
                        <input type="text" class="form-control input-sm" id="last_name" name="last_name" value="<?php echo $last_name['value'] ?>">
                        <label for="last_name"><?php echo lang('edit_user_lname_label', 'last_name'); ?></label>
                      </div>
                    </div>
                  </div>
                  <div class="form-group form-md-line-input form-md-floating-label">
                    <input type="text" class="form-control input-sm" id="company" name="company" value="<?php echo $company['value'] ?>">
                    <label for="company"><?php echo lang('edit_user_company_label','company') ?></label>
                  </div>
                  <div class="form-group form-md-line-input form-md-floating-label">
                    <input type="text" class="form-control input-sm" id="phone" name="phone" value="<?php echo $phone['value'] ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group form-md-line-input form-md-floating-label">
                        ...
                        <label for="confirm_password"><?php echo lang('edit_user_password_confirm_label','password_confirm') ?></label>
                      </div>
                    </div>
                  </div>
                ...
                <div class="form-actions noborder">
                  <button type="submit" class="btn blue"><?php echo lang('edit_user_submit_btn') ?></button>
