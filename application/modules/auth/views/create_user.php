...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      <!-- BEGIN PAGE HEADER-->
      <h3 class="page-title">
      <?php echo lang('create_user_heading');?> <small><?php echo lang('create_user_subheading');?></small>
      </h3>
      <div class="page-bar">
              ...
              <form role="form" action="<?php echo base_url('auth/create_user') ?>" method="POST">
                <div class="form-body">
                  ...
                  if($identity_column!=='email') {
                      ...
                      echo '<input type="text" class="form-control input-sm" id="identity" name="identity">';
                      echo '<label for="identity">'.lang('create_user_identity_label', 'identity').'</label>';
